...
This introduction to R is very brief and only geared toward giving you some basics so that you can understand and run the code for this course.  If you have some basic familiarity with R you may skip this chapter, though it might serve as a refresher for some.
