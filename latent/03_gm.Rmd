...
```{r conditionalIndependence, echo=FALSE, eval=FALSE}
DiagrammeR("
digraph DAG {
  # Intialization of graph attributes
  graph [overlap = false]
...
#### Multiple Targets
While relatively seldom used, multivariate linear regression[^mvreg] is actually very straightforward in some programming environments such as R.  Using the McClelland data, let's try it for ourselves. First, let's look at the data to get a sense of things.
...
```{r summaryPaMultipleTargets2, eval=FALSE}
summary(mvregModel)
```
