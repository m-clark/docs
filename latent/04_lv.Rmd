...
tags$div(style="width:500px; margin-left:auto;  margin-right:auto",
         d3heatmap::d3heatmap(pc$loadings, colors=scales::col_bin(RColorBrewer::brewer.pal(11, "RdBu"), domain=c(-.1,1), bins=2), width=500))
```
