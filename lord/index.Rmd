...
### Aside
We can model the change score while adjusting for initial weight (and we should if it correlates with the effect of interest). Note that doing so duplicates the ANCOVA result for the group effect (i.e. it is the direct effect). But note that the coefficient for initial weight is equivalent to the ANCOVA coefficient -1. See for example, Senn 2006.
